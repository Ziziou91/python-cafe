...
def owner_stock(owner_func: Callable, app: Callable) -> None:
    ...
    resolve_amend_item_inputs(menu_item, user_input, owner_stock, app)

def validate_new_value_type(command_str: str, new_value: str, menu_item: list, owner_stock: Callable, app: Callable) -> int or float:
...
def resolve_amend_item_inputs(menu_item: str, user_input: str or list, owner_stock: Callable, app:Callable) -> None:
    ...
    try:
        ...
        if command_str == "exit":
            ...
            stock[menu_item[0]][command_str] = validate_new_value_type(command_str, new_value, menu_item, owner_stock, app)
            print(draw_item(menu_item))
        else:
