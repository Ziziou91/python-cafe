...
def route_customer_requests(user_str: str, prompt: str, called_from: str, handle_input: Callable):
    ...
    if called_from == "customer":
        return validate_customer_inputs(user_str, prompt, called_from, handle_input)
...
def validate_customer_inputs(user_str: str, prompt: str, called_from: str, handle_input) -> list:
